...
<head>
  <meta charset="UTF-8" />
  <title>Ananaka Admin Dashboard | Error 404</title>
  ...
  <!-- PAGE LEVEL STYLES -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/admin/css/error.css" />
  ...
  <div class="col-lg-8 col-lg-offset-2 text-center">
    ...
    <div class="col-lg-6col-lg-offset-3">
      <div class="btn-group btn-group-justified">
        <a href="<?php echo base_url(); ?>panel/dashboard" class="btn btn-primary">Return Dashboard</a>
        <a href="<?php echo base_url(); ?>" class="btn btn-success">Return Website</a>
      </div>
    </div>
  </div>
</div>
